...
const Dashboard = ({
  ...
  return (
    <div className="flex justify-center border-0 items-center h-full w-full flex-1 flex-col gap-2 border-neutral-200 bg-white p-6 md:p-8 dark:border-neutral-700 dark:bg-zinc-900">
