...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 text-white overflow-hidden">
      {/* Background elements with subtle cyan tint */}
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-4 sm:px-6 lg:px-8 py-4 sm:py-6 backdrop-blur-sm bg-zinc-950/80 border-b border-zinc-800/50">
        ...
        {/* Mobile-friendly navigation */}
          ...
          <a href="#features" className="text-base lg:text-lg text-zinc-400 hover:text-cyan-400 transition-colors">
            Features
          </a>
          <a href="#pricing" className="text-base lg:text-lg text-zinc-400 hover:text-cyan-400 transition-colors">
            Pricing
          </a>
          <a href="#technology" className="text-base lg:text-lg text-zinc-400 hover:text-cyan-400 transition-colors">
            Technology
          </a>
        </nav>
        
        {/* Mobile menu button - you would implement the toggle functionality */}
        <button className="md:hidden text-zinc-400 focus:outline-none">
      ...
      {/* Hero section with improved spacing for all devices */}
      <main className="flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-28 pb-16 sm:pt-32 sm:pb-20 md:pt-36 md:pb-24 mt-4 z-10 relative">
        {/* <h2 className="font-extrabold mb-6 text-white opacity-100"> */}
          <TypewriterEffectSmooth
      ...
      {/* Features section with improved layout for all screen sizes */}
      <section id="features" className="py-16 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-3 sm:mb-4">Powerful Features</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-xl p-4 sm:p-6 hover:border-cyan-900/30 transition-all hover:shadow-lg hover:shadow-cyan-950/10"
              >
      ...
      {/* Technology section with improved card layout */}
      <section id="technology" className="py-16 sm:py-20 bg-gradient-to-b from-zinc-900/50 to-zinc-950 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Built With Modern Technology</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 sm:gap-6">
            {techStack.map((tech, index) => (
              ...
              >
                <div className="text-cyan-100 font-mono text-sm sm:text-base">{tech.name}</div>
                <div className="text-zinc-500 text-xs sm:text-sm mt-1">{tech.category}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Subscription Plans (component remains unchanged) */}
      <SubscriptionPlans />

      {/* Improved responsive footer */}
      <footer className="w-full bg-zinc-900/50 py-6 sm:py-8 text-center border-t border-zinc-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-xl sm:text-2xl font-bold mb-4">Ready to Transform Your Cloud Workflow?</h3>
          <button
            onClick={handleFreeClick}
          ...
          <p className="text-zinc-400 text-sm">© {new Date().getFullYear()} CloudDrop. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
