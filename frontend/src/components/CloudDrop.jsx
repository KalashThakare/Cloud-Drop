    ...
    <div className="w-full h-full flex items-start md:items-center justify-center py-20">
      ...
      >
        <div className="flex flex-col md:flex-row gap-6 justify-evenly">
          ...
          <div
            className={`flex flex-col gap-2 sm:gap-3 transition-all duration-300 ${selectedFileIndex === null ? "w-full" : "w-full md:w-1/2"
              }`}
          >
            ...
            {files.length > 0 && (
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
                {files.map((file, index) => (
                  <div
                    className={`relative cursor-pointer group border-2 ${selectedFileIndex === index
                        ? "border-cyan-400"
                        : "border-transparent"
                      } rounded-lg`}
                    key={index}
          ...
          <div
            className={`transition-all duration-300 ${selectedFileIndex === null
        ...
        <div className="sticky bottom-0 left-0 w-full flex justify-center z-10 pt-2 pb-2 bg-transparent">
          <button
            ...
            className={`w-3/4 py-3 text-white text-sm sm:text-base font-medium rounded-xl transition-all ${isUploading || files.length === 0
